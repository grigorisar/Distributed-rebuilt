...
<body>
    ...
    <div class="pure-g">
        ...
        <!-- style="display:none" -->
                        ...
                        <div  class="form-group" >
                            <label for="failed">Failed Classes</label><br>
                            <input required step="1" type="number" pattern="\d+" name="failed_u" id="failed_u" placeholder="Failed Classes" maxlength="2"><br>

                        </div>

                        <div  class="form-group" >
                            <input hidden type="text" required name="role_u" id="role_u" value="Student" ><br>
                        </div>
